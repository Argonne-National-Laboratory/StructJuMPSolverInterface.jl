...
function scopf_solve(opfmodel, scopf_data, case)
  # 
  ...
  for c in 1:ncont
    opfm1=opf_loaddata(case, scopf_data.lines_off[c])
...
function scopf_model(scopf_data, case)
  sd=scopf_data
  ...
  for co=0:ncont
    ...
    if co==0
      ...
      opfm1=opf_loaddata(case, sd.lines_off[co]) 
